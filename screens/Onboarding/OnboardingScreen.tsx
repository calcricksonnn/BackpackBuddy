  ...
  return (
    <Swiper loop={false} dotColor="#ccc" activeDotColor="#007AFF">
      {slides.map((slide, index) => (
        <ImageBackground key={index} source={slide.bg} style={styles.slide}>
